...
public class StunAddressDiscovererTest extends TestCase {
    ...
    private StunAddress            discovererAddress     = new StunAddress("127.0.0.1", 15555);

    private ResponseSequenceServer responseServer        = null;
    private StunAddress            responseServerAddress = new StunAddress("127.0.0.1", 19999);


    private StunAddress            mappedClientAddress = new StunAddress("212.56.4.10", 15612);
    private StunAddress            mappedClientAddressPort2 = new StunAddress("212.56.4.10", 15611);
